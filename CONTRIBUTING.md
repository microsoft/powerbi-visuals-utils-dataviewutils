...
## Reporting issues
We use [GitHub issues](https://github.com/Microsoft/powerbi-visuals-utils-dataviewutils/issues) as an issue tracker for the repository. Firstly, please search in open issues and try to make sure your problem doesn't exist. If there's an issue add your comments to this issue.
If there isn't an issue please open a new one.
